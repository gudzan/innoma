...
function playVideo() {
    document
        .querySelector(".video__box-black")
        .classList.remove("video__box-black--visibile");
...
window.addEventListener("resize", function () {
    if (
        ...
        !autorisationBlock.classList.contains("autorisation--open")
    ) {
        closeBurger();
    }
});
...
function toggleMarketsMap() {
    ...
    document
        .querySelector(".markets__map-box--active")
        .classList.toggle("markets__map-box--active");

    if (this.classList.contains("markets__country-east")) {
        document
            .querySelector(".markets__map-box--east")
            .classList.add("markets__map-box--active");
    }
    if (this.classList.contains("markets__country-asia")) {
        document
            .querySelector(".markets__map-box--asia")
            .classList.add("markets__map-box--active");
    }
    if (this.classList.contains("markets__country-america")) {
        document
            .querySelector(".markets__map-box--america")
            .classList.add("markets__map-box--active");
    }
    if (this.classList.contains("markets__country-africa")) {
        document
            .querySelector(".markets__map-box--africa")
            .classList.add("markets__map-box--active");
    }
}
